...
#
# building scripts for znp-host-framework
#
...
if "mipsel" == platform:
    EXE_PATH = "~/build/openwrt/staging_dir/toolchain-mipsel_24kec+dsp_gcc-4.8-linaro_uClibc-0.9.33.2/bin/"
    PREFIX = EXE_PATH + "mipsel-openwrt-linux-uclibc-"
    STAGING_DIR = "~/build/openwrt/staging_dir/target-mipsel_24kec+dsp_uClibc-0.9.33.2/"
elif "arm" == platform:
    EXE_PATH = "~/build/buildroot/output/host/usr/bin/"
